...
def repeated_forward_a_star_search(actual_maze: Maze, vision_maze: Maze, start: Cell, goal: Cell) -> dict:
...
def draw_maze(screen):
    ...
    repeated_forward_a_star_search(maze, vision_maze, start, goal)
